...
STORAGES = {
    ...
    "staticfiles": {
        "BACKEND": (
            ...
            if env_bool("STATICFILES_MANIFEST", IS_RAILWAY)
...
FEED_ON_ONTOLOGY_PATH = os.getenv("FEED_ON_ONTOLOGY_PATH", "ontology/FEED-ON-v0.2.owl")
FEED_ON_ONTOLOGY_VERSION = os.getenv("FEED_ON_ONTOLOGY_VERSION", "0.2")
...
SEMANTIC_EXTRACTION_PROMPT_VERSION = os.getenv("SEMANTIC_EXTRACTION_PROMPT_VERSION", "feed-on-semantic-v2-target-typing")
CANONICAL_TARGET_MAP_VERSION = os.getenv("CANONICAL_TARGET_MAP_VERSION", "feed-on-target-map-v1")
